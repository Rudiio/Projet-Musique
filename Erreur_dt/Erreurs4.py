...
D=0.001
N=arange(0.000021,0.00000001,-0.0000005)
Nb=N.size
print(Nb)
NN=zeros(Nb)
...
for I in range(Nb):
    ...
    dx=c*dt #pas entre deux points de l'espace
...
plt.xlabel("temps")
plt.ylabel("erreur")
plt.title("erreurs en fonction de dt pour les 3 méthodes")
plt.grid("True")
plt.legend()
plt.show()
